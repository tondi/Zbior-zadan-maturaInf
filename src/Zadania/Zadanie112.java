...
public class Zadanie112 {
	...
	public Zadanie112() {
		...
		// Stworz ich reprezentacjê w strukturze danych
		while (plikKraje.hasNextLine()) {

			String line = plikKraje.nextLine();

			// Inner Scanner, bo linie maj¹ ró¿ne d³ugoœci danych (np
...
//				produkt.put("nazwa", lineScanner.next());
		...
		// System.out.println("Iloœæ b³êdnych pomiarów we wszystkich 3 stacjach w tym samym czasie: "
		// + ileBlednychWeWszystkich3);
		// };
		// void pp3() {
		// int rekord1 = -1000;
